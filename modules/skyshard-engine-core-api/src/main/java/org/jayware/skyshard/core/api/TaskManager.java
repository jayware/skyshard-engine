...
{
    TaskConfigurationBuilder createConfiguration() throws IllegalArgumentException;

    TaskResult submit(Task task) throws TaskSchedulingException, IllegalArgumentException;

    TaskResult submit(Task task, TaskConfiguration configuration) throws TaskSchedulingException, IllegalArgumentException;
}
